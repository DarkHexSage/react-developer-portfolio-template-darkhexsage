  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          <li>
			...
			C249.04,210.834,249.133,199.834,249.221,192.496z" fill="#666666"/>
      <path d="M248.537,384.397c-26.046-2.336-44.601-18.672-44.601-18.672c-2.873,3.958-5.874,8.104-8.909,12.564
			...
			c0,9.201-7.462,16.676-16.698,16.676c-9.189,0-16.663-7.475-16.663-16.676C347.77,410.53,355.231,403.069,364.421,403.069z" fill="#666666"/>
      <path d="M292.361,146.599c2.487,0.28,4.939,0.409,7.368,0.409c14.783,0,28.668-4.975,39.142-13.703
			...
			C264.657,77.167,277.929,66.844,294.714,66.143z" fill="#666666"/>
      <path d="M544.505,31.486c-4.787-6.86-12.098-11.835-20.598-14.036c-12.635-3.24-25.971,0.502-33.888,8.991
			...
			C525.401,52.487,522.436,54.35,518.676,54.612z" fill="#666666"/>
